...
contract Escrow {
  ...
  mapping (address => uint) private deposit_accounts; //list of organizations depsoiting
  ...
  event Purchased(address _purchaser); //event for conversion agents to purchase eth/dai
  event Authenticate(address _depositer); //event for depositer to authenticate purchases of eth/dai
